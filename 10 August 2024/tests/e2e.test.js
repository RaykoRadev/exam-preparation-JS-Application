    ...
    "catalog": [
        {
            ...
            "description":
                "A quirky and edgy tattoo featuring an animated bunny with a mischievous grin, clutching a knife, blending cuteness with a dark twist.",
        ...
        },
        {
            ...
            "description":
                "A majestic Japanese dragon wrapped in swirling clouds and flames, symbolizing strength, wisdom, and protection.",
        ...
        },
        {
            ...
            "description":
                "A striking Trash Polka tattoo of a skull, combining bold black and red ink with abstract elements, exuding a sense of rebellion and raw artistry.",
...
const endpoints = {
    ...
    own: (tattooId, userId) =>
        `/data/tattoos?where=_id%3D%22${tattooId}%22%20and%20_ownerId%3D%22${userId}%22&count`,
    like: "/data/likes",
    totalLikes: (tattooId) =>
        `/data/likes?where=tattooId%3D%22${tattooId}%22&distinct=_ownerId&count`,
    userLikes: (tattooId, userId) =>
...
describe("E2E tests", function () {
    ...
    describe("Navigation bar [ 10 Points ]", () => {
        it("Logged user should see correct navigation [ 2.5 Points ]", async function () {
            ...
            //Test for navigation
            await page.waitForSelector("nav >> text=Collection", {
                timeout: interval,
            });
        ...
        it("Guest user should see correct navigation [ 2.5 Points ]", async function () {
            ...
            expect(await page.isVisible("nav"), "Dashboard is not visible").to
                .be.true;
            expect(
                await page.isVisible("nav >> text=Add Tattoo"),
                "Create is visible",
            ).to.be.false;
            expect(
        ...
        it("Guest user navigation should work [ 2.5 Points ]", async function () {
            ...
            let tattoosBtn = await page.waitForSelector(
                "nav >> text=Collection",
                { timeout: interval },
            );
    ...
    describe("Home Page [ 5 Points ]", function () {
        it("Show Home page text [ 2.5 Points ]", async function () {
            ...
            await page.waitForSelector(
                "text=Whether you're a seasoned artist, a collector of ink, or someone looking for inspiration for their first tattoo,",
                { timeout: interval },
            );
            expect(
    ...
    describe("Dashboard Page [ 15 Points ]", function () {
        it("Show Collection page - welcome message [ 2.5 Points ]", async function () {
            ...
            await page.waitForSelector("main >> text=Collection", {
                timeout: interval,
            });
        ...
        it("Check Collection page with 0 tattoos [ 2.5 Points ]", async function () {
            ...
            await page.waitForSelector(
                "text=Collection is empty, be the first to contribute",
                { timeout: interval },
            );
            expect(
                await page.isVisible(
        ...
        it("Check Collection have correct User Type [ 2.5 Points ]", async function () {
            ...
            await page.waitForSelector(".tattoo .user-type", {
                timeout: interval,
            });
        ...
        it("Check Collection have Learn More button [ 2.5 Points ]", async function () {
            ...
            await page.waitForSelector(".tattoo >> text=Learn More", {
                timeout: interval,
            });
            const buttons = await page.$$eval(
                ".tattoo >> text=Learn More",
    ...
    describe("CRUD [ 50 Points ]", () => {
        ...
        describe("Details [ 10 Points ]", function () {
            it("Details calls the correct API [ 2.5 Points ]", async function () {
                ...
                let learnMoreButton = await page.waitForSelector(
                    `.tattoo-info:has-text("${data.type}") >> .details-btn`,
                    { timeout: interval },
                );
            ...
            it("Details with guest calls shows correct info [ 2.5 Points ]", async function () {
                ...
                let learnMoreElement = await page.waitForSelector(
                    "#user-type",
                    { timeout: interval },
                );
        ...
        describe("Edit [ 17.5 Points ]", function () {
            ...
            it("Edit should populate form with correct data [ 2.5 Points ]", async function () {
                ...
                await page.waitForSelector(".edit-form select", {
                    timeout: interval,
                });
                ...
                const selects = await page.$$eval(".edit-form select", (s) =>
                    s.map((s) => s.value),
                );
            ...
            it("Edit does NOT work with empty fields [ 2.5 Points ]", async function () {
                ...
                let learnMoreInput = await page.waitForSelector(
                    '[name="user-type"]',
                    { timeout: interval },
                );
    ...
    describe("BONUS: Likes [ 15 Points ]", async () => {
        ...
        it("Liking for valid user increments likes and hides Like button [ 2.5 Points ]", async function () {
            ...
            likesElement = await page.waitForSelector("#like", {
                timeout: interval,
            });
